 ...
 */
package com.cv.generator.convert;
        ...
        if (t.contains("char")) {
            ...
            switch (dateType) {
                ...
                case TIME_PACK:
                    switch (t) {
                        case "date":
                            return DbColumnType.LOCAL_DATE;        // 改为 LocalDate
                        case "time":
                            return DbColumnType.LOCAL_TIME;        // 改为 LocalTime
                        case "year":
                            return DbColumnType.YEAR;
                        default:
                            return DbColumnType.LOCAL_DATE_TIME;   // 改为 LocalDateTime
                    }
            }
        }
        return DbColumnType.STRING;
